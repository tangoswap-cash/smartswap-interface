...
export default function MigrateV2() {
  ...
  return (
    <Container id="migrate-page" className="py-4 space-y-6 md:py-8 lg:py-12" maxWidth="2xl">
      <Head>
          <title key="title">Migrate LP tokens | SmartSwap</title>
          <meta
            key="description"
            name="description"
            content="Migrate LP tokens to Tango LP tokens"
          />
          <meta key="twitter:url" name="twitter:url" content="https://smartswap.fi/migrate" />
          ...
          <meta
            ...
            content="Migrate LP tokens to Tango LP tokens"
          />
          <meta key="twitter:image" name="twitter:image" content="https://smartswap.fi/xtango-sign.png" />
          <meta key="og:title" property="og:title" content="MIGRATE LP" />
          <meta key="og:url" property="og:url" content="https://smartswap.fi/migrate" />
          <meta key="og:image" property="og:image" content="https://smartswap.fi/xtango-sign.png" />
          <meta
            key="og:description"
